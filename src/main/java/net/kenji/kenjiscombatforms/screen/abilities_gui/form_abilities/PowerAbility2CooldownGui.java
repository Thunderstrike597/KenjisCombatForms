...
public class PowerAbility2CooldownGui {
    ...
    public static void onRenderGameOverlay(RenderGuiOverlayEvent event) {
        ...
        ResourceLocation abilityResource = new ResourceLocation(KenjisCombatForms.MOD_ID, "textures/gui/abilities/power_abilities/power_ability2_gui.png");
        ResourceLocation abilityBgResource = new ResourceLocation(KenjisCombatForms.MOD_ID, "textures/gui/abilities/power_abilities/power_ability2_bg-gui.png");
        ResourceLocation abilityOverlayResource = new ResourceLocation(KenjisCombatForms.MOD_ID, "textures/gui/abilities/power_abilities/power_ability2_gui_overlay.png");
