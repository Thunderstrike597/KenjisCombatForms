...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<ScrollTraderEntity>> SCROLL_TRADER = ENTITYTYPES.register("scroll_trader", () -> EntityType.Builder.of(ScrollTraderEntity::new, MobCategory.AMBIENT)
