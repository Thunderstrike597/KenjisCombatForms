...
public class WitherPlayerModel<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	private final ModelPart wither_player_model;
	...
	public WitherPlayerModel(ModelPart root) {
		this.wither_player_model = root.getChild("wither_player_model");
		this.body = wither_player_model.getChild("body");
		this.torso = wither_player_model.getChild("body").getChild("torso");
		this.head =  wither_player_model.getChild("body").getChild("torso").getChild("head");
		this.left_arm =  wither_player_model.getChild("body").getChild("left_arm");
		this.right_arm =  wither_player_model.getChild("body").getChild("right_arm");
		this.left_leg =  wither_player_model.getChild("body").getChild("left_leg");
		this.right_leg =  wither_player_model.getChild("body").getChild("right_leg");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition wither_player_model = partdefinition.addOrReplaceChild("wither_player_model", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition body = wither_player_model.addOrReplaceChild("body", CubeListBuilder.create(), PartPose.offset(0.0F, -24.0F, 0.0F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		wither_player_model.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
	public ModelPart root(){
		return wither_player_model;
	}
}