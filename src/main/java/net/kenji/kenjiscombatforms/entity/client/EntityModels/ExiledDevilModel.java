...
public class ExiledDevilModel<T extends Entity> extends EntityModel<T> {
	...
	public ExiledDevilModel(ModelPart root) {
		...
		this.head = exiled_devil.getChild("body").getChild("torso").getChild("head");
		this.left_arm = exiled_devil.getChild("body").getChild("left_arm");
		this.right_arm = exiled_devil.getChild("body").getChild("right_arm");
		this.left_leg = exiled_devil.getChild("body").getChild("left_leg");
		this.right_leg = exiled_devil.getChild("body").getChild("right_leg");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition swiftness_sensei = partdefinition.addOrReplaceChild("exiled_devil", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		exiled_devil.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
