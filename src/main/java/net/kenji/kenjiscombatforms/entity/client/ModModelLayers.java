...
public class ModModelLayers {
    public static final ModelLayerLocation EXILED_DEVIL_LAYER = new ModelLayerLocation(
            new ResourceLocation(KenjisCombatForms.MOD_ID, "exiled_devil_layer"), "main");

    public static final ModelLayerLocation EXILED_SENSEI_LAYER = new ModelLayerLocation(
            new ResourceLocation(KenjisCombatForms.MOD_ID, "exiled_sensei_layer"), "main");

    public static final ModelLayerLocation UNDEAD_SENSEI_LAYER = new ModelLayerLocation(
            new ResourceLocation(KenjisCombatForms.MOD_ID, "undead_sensei_layer"), "main");
