...
public class SenseiModel<T extends LivingEntity> extends HumanoidModel<T> implements VillagerHeadModel {
    private final ModelPart hatRim = this.hat.getChild("hat_rim");

    public SenseiModel(ModelPart pRoot) {
        super(pRoot);
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("jacket", CubeListBuilder.create().texOffs(0, 38).addBox(-4.0F, 0.0F, -3.0F, 8.5F, 20.0F, 6.5F, new CubeDeformation(0.05F)), PartPose.offset(0.0F, 0.0F, 0.0F));
