...
public class WitherFistCombos extends BaseComboBuilder {
    ...
    public static Skill buildSkills(String skillName, SkillBuildEvent.ModRegistryWorker registryWorker, FistTier tier) {
        ...
        /// Tier 1
        ComboNode basic1 = createComboNode(AnimsMoonless.MOONLESS_AUTO_1_VERSO);
        ComboNode basic2 = createComboNode(AnimsAgony.AGONY_AUTO_2);
        ComboNode basic3 = createComboNode(AnimsAgony.AGONY_AUTO_1, 1.5F);
        ComboNode basic4 = createComboNode(AnimsAgony.AGONY_AUTO_1, 1.5F);
        ...
        ComboNode basic6 = createComboNode(AnimsEnderblaster.ENDERBLASTER_ONEHAND_AUTO_2, 1.6F);
        ComboNode basic7 = createComboNode(AnimsMoonless.MOONLESS_AUTO_2);
        ComboNode basic8 = createComboNode(AnimsEnderblaster.ENDERBLASTER_ONEHAND_AUTO_4, 1.5F);
        /// Tier 3
        ComboNode basic9 = createComboNode(AnimsEnderblaster.ENDERBLASTER_ONEHAND_AUTO_1, 1.5F);
        ComboNode basic10 = createComboNode(AnimsAgony.AGONY_AUTO_2, 1.5F);
        ComboNode basic11 = createComboNode(AnimsMoonless.MOONLESS_AUTO_3_VERSO, 1.5F);
        ComboNode basic12 = createComboNode(AnimsMoonless.MOONLESS_AUTO_3, 1.5F);
        ComboNode basic13 = createComboNode(AnimsAgony.AGONY_AUTO_1);

        ComboNode dash = switch (tier.value) {
            default -> createComboNode(AnimsMoonless.MOONLESS_REWINDER).addCondition(new SprintingCondition());
        };
        ComboNode airSlash = switch (tier.value) {
            default -> createComboNode(AnimsEnderblaster.ENDERBLASTER_TWOHAND_TISHNAW).addCondition(new InAirCondition());
        };
        ComboNode leftDodgeAttack = createDodgeComboNode(WOMAnimations.SHADOWSTEP_LEFT, basicLeft1).addCondition(new LeftCondition());
    ...
    private static ComboNode createDodgeComboNode(AnimationManager.AnimationAccessor<? extends StaticAnimation> animation, ComboNode followUpCombo){
        ComboNode node = ComboNode.createNode(animation).setConvertTime(0.0F).setPlaySpeed(0.75F);
