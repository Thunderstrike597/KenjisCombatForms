...
public class VoidForm3Item extends BaseFormClass {

    private final EnderFormAbility enderFormAbility;
    private static final long PRESS_COOLDOWN = 4;

    public VoidForm3Item(Tier tier, int damageIn, float speedIn, Properties builder) {
        super(tier, damageIn, speedIn, builder);
        this.enderFormAbility = EnderFormAbility.getInstance();
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.kenjiscombatforms.void_form_type3.tooltip"));
