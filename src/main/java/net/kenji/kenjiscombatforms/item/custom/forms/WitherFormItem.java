...
public class WitherFormItem extends BaseFormClass {

    WitherDash witherDash = WitherDash.getInstance();
    private static final long PRESS_COOLDOWN = 4;

    public WitherFormItem(Tier tier, int damageIn, float speedIn, Properties builder) {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.kenjiscombatforms.wither_form.tooltip"));
