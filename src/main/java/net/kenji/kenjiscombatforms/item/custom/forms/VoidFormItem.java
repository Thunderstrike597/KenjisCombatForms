...
public class VoidFormItem extends BaseFormClass {
    private final TeleportPlayer teleportPlayer;

    private final EnderFormAbility shadowFormAbility;
    private final TeleportPlayerBackstab teleportPlayerBackstab;
    private static final long PRESS_COOLDOWN = 4;

    public VoidFormItem(Tier tier, int damageIn, float speedIn, Properties builder) {
        ...
        this.shadowFormAbility = EnderFormAbility.getInstance();
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.kenjiscombatforms.void_form.tooltip"));
