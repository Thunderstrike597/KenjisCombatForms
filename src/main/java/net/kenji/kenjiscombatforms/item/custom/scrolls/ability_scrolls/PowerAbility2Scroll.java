...
public class PowerAbility2Scroll extends BaseUseItem {
    private static PowerAbility2Scroll INSTANCE;
    ...
    private final AbilityManager.AbilityOption2 ability = AbilityManager.AbilityOption2.POWER_ABILITY2;

    public PowerAbility2Scroll(Properties properties) {
    ...
    public static PowerAbility2Scroll getInstance(){
        return INSTANCE;
    }
