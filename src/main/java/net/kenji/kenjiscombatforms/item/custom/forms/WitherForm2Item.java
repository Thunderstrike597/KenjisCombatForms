...
public class WitherForm2Item extends BaseFormClass {

    SoulDrift soulDrift = SoulDrift.getInstance();
    private static final long PRESS_COOLDOWN = 4;

    public WitherForm2Item(Tier tier, int damageIn, float speedIn, Properties builder) {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.kenjiscombatforms.wither_form_type2.tooltip"));
