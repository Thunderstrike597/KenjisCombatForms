...
public class VoidAbility1Scroll extends BaseUseItem {
    private static VoidAbility1Scroll INSTANCE;
    ...
    private final AbilityManager.AbilityOption1 ability = AbilityManager.AbilityOption1.VOID_ABILITY1;

    public VoidAbility1Scroll(Properties properties) {
    ...
    public static VoidAbility1Scroll getInstance(){
        return INSTANCE;
    }
