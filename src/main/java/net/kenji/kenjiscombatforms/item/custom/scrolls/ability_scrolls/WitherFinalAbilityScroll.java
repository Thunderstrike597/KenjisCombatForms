...
public class WitherFinalAbilityScroll extends BaseUseItem {
    private static WitherFinalAbilityScroll INSTANCE;
    ...
    private final AbilityManager.AbilityOption3 ability = AbilityManager.AbilityOption3.WITHER_FINAL;

    public WitherFinalAbilityScroll(Properties properties) {
    ...
    private void setFormAbility(Player player){
        if(player instanceof ServerPlayer serverPlayer) {
                ...
                formAbilityStrategy = new WitherForm.CurrentFormAbilityStrategy();
    ...
    public static WitherFinalAbilityScroll getInstance(){
        return INSTANCE;
    }
    ...
    public void releaseUsing(ItemStack stack, Level level, LivingEntity entity, int timeLeft) {
        if (entity instanceof Player player) {
            ...
            if(formData.selectedForm == FormManager.FormSelectionOption.WITHER) {
