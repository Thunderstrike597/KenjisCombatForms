...
public class ClientBasicFistData {
    ...
    public static void setBasicAbility1(Player player, AbilityManager.AbilityOption1 value) {
        clientData.setCurrentStoredAbility1(value);
    }
    public static void setBasicAbility2(Player player, AbilityManager.AbilityOption2 value) {
